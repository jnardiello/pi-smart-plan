...
- CLOSING: this phase's structured tools are plan_next, plan_save, plan_verify and ask_smart_plan — owner-facing turns close with them; turns that close in prose are regenerated by the harness. The goal closes when plan_complete validates it.`,
} as const;
